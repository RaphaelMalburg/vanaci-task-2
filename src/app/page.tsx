          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900 dark:text-white leading-tight">
                Farmácia Vanaci
                <br />
                <span className="text-3xl md:text-5xl text-blue-600 dark:text-blue-400">Cuidando da Sua Saúde</span>
              </h1>

              <p className="text-lg md:text-xl mb-8 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Medicamentos de qualidade, atendimento especializado e a confiança que você merece. Sua saúde é nossa prioridade há mais de 15 anos.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white text-lg px-8 py-3 font-medium transition-colors duration-200">
            ...
            <div className="flex justify-center">
              <Image src="/hero.png" alt="Farmácia Vanaci - Cuidando da sua saúde" width={600} height={450} className="w-full max-w-lg h-auto rounded-lg shadow-lg" priority />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 glass-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="glass-card inline-flex items-center px-6 py-3 text-primary text-sm font-medium mb-6">Nossos Diferenciais</div>
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Por que Escolher a Farmácia Vanaci?</h2>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="text-center lg:text-left">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">Produtos em Destaque</h2>
            ...
            <div className="relative">
              <Image src="/pharmacy-team.png" alt="Equipe farmacêutica especializada" width={600} height={400} className="w-full h-auto rounded-2xl shadow-lg" />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-0 bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-800 dark:to-blue-900/20 overflow-hidden">
              ...
              <CardHeader className="relative">
                ...
                <CardDescription className="text-gray-600 dark:text-gray-300 mb-6">Analgésico e antitérmico de ação rápida</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="group hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-0 bg-gradient-to-br from-white to-green-50/50 dark:from-gray-800 dark:to-green-900/20 overflow-hidden">
              ...
              <CardHeader className="relative">
                ...
                <CardDescription className="text-gray-600 dark:text-gray-300 mb-6">Suplemento vitamínico para imunidade</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex justify-between items-center">
                  <div>
            ...
            <Card className="group hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-0 bg-gradient-to-br from-white to-purple-50/50 dark:from-gray-800 dark:to-purple-900/20 overflow-hidden">
              ...
              <CardHeader className="relative">
                ...
                <CardDescription className="text-gray-600 dark:text-gray-300 mb-6">Analgésico e antitérmico eficaz</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex justify-between items-center">
                  <div>
      ...
      <section className="relative py-24 bg-blue-600 dark:bg-blue-800 text-white">
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-12 text-blue-100 max-w-3xl mx-auto leading-relaxed">
            ...
            Use nosso chat online 24/7 ou visite nossa farmácia.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Button
              size="lg"
              className="px-10 py-4 text-lg border-2 border-white bg-transparent text-white hover:bg-white hover:text-blue-600 shadow-xl transition-all duration-300 font-semibold">
              Iniciar Chat Online
            </Button>
          </div>
